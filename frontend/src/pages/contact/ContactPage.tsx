  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        <div className="mt-8 bg-gray-900/60 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm text-gray-300">Digital Kookie Hub</span>
            </div>
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-primary-400 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <a href="https://www.hireez.online" target="_blank" rel="noopener noreferrer" className="text-sm text-primary-400 hover:text-primary-300 transition-colors">
                www.hireez.online
              </a>
            </div>
            <div className="flex items-start gap-3">
              ...
              <a href="mailto:support@hireez.online" className="text-sm text-primary-400 hover:text-primary-300 transition-colors">
            ...
            <div className="flex items-start gap-3">
              ...
              <a href="tel:+919384818482" className="text-sm text-primary-400 hover:text-primary-300 transition-colors">
                +91 9384818482
              </a>
            </div>
          </div>
