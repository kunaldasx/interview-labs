			...
			<div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
				<div className="w-full max-w-md text-center animate-fade-in-up">
					...
					<p className="text-gray-400 mb-8">
						Thank you for your interest in InterviewLabs. Our team will get back
						to you shortly.
					</p>
					<Link
						to="/"
			...
			<div className="w-full max-w-4xl relative z-10 animate-fade-in-up">
				<div className="text-center mb-8">
					...
					<p className="text-gray-400 mt-2 text-sm">
						See how InterviewLabs can transform your hiring process. Fill out
						the form and our team will reach out.
					</p>
				</div>
						...
						<div className="space-y-5">
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<a
										href="https://www.interviewLabs.net"
										target="_blank"
										rel="noopener noreferrer"
										className="text-sm font-medium text-primary-400 hover:text-primary-300 transition-colors"
									>
										www.interviewLabs.net
									</a>
								</div>
							</div>
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<a
										href="mailto:support@interviewLabs.net"
										className="text-sm font-medium text-primary-400 hover:text-primary-300 transition-colors"
									>
										support@interviewLabs.net
									</a>
								</div>
							</div>
							<div className="flex items-start gap-4">
