...
const features = [
	{
		...
		description:
			"Conduct intelligent interviews with AI that adapts questions based on candidate responses in real-time.",
	},
	{
		icon: (
			<svg
		...
		description:
			"Pre-built question banks across Healthcare, Finance, Manufacturing, Logistics, and Engineering.",
	},
	{
		icon: (
			<svg
		...
		description:
			"AI-powered resume parsing and screening to shortlist the best candidates automatically.",
	},
	{
		icon: (
			<svg
		...
		description:
			"Instant scoring and detailed evaluation reports with actionable hiring recommendations.",
	},
	{
		icon: (
			<svg
		...
		description:
			"Flexible interview modes — text chat, voice-based, or video interviews to suit every scenario.",
	},
	{
		icon: (
			<svg
		...
		description:
			"Comprehensive dashboards and reports to track hiring metrics and optimize your recruitment pipeline.",
	},
];
...
export default function HomePage() {
	...
	const { openCheckout, isProcessing: isCheckoutProcessing } =
		useDodoCheckout();
				...
				<div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
					<div className="flex items-center gap-3">
						<span className="text-xl font-bold text-white">
							Hire<span className="text-primary-400">Glint</span>
							<span className="text-primary-300 text-sm">.ai</span>
						</span>
					</div>
			...
			<section className="relative overflow-hidden">
				...
				<div className="relative z-10 max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
					...
					<p className="mt-6 text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
						Screen, interview, and evaluate candidates across 32 industry
						domains — powered by AI.
					</p>
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="mt-4 text-gray-400 max-w-xl mx-auto">
							A complete AI-powered interview platform built for non-IT
							industries.
						</p>
					</div>
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-12">
						...
						<div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
							...
							<div className="flex items-center gap-3">
								<span
									className={`text-sm font-medium ${!isStudent ? "text-white" : "text-gray-500"}`}
								>
									Business
								</span>
								<button
								...
								>
									<span
										className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${isStudent ? "translate-x-6" : ""}`}
									/>
								</button>
								<span
									className={`text-sm font-medium ${isStudent ? "text-white" : "text-gray-500"}`}
							...
							<div className="relative rounded-2xl p-8 bg-gradient-to-br from-emerald-600 to-teal-700 text-white shadow-2xl shadow-emerald-500/25">
								...
								<div className="text-center mb-6">
									...
									<p className="mt-2 text-sm text-emerald-100">
										Affordable AI interview practice for college students
								...
								<div className="text-center mb-6">
									...
									<p className="text-xs mt-2 text-emerald-200">
										One-time per interview session
									</p>
								</div>
								...
								<ul className="mt-8 space-y-3">
									{[
										...
										<li key={feature} className="flex items-start gap-3">
											<svg
												className="w-5 h-5 flex-shrink-0 mt-0.5 text-emerald-200"
												fill="none"
												viewBox="0 0 24 24"
												stroke="currentColor"
												strokeWidth={2}
								...
								<div className="mt-6 pt-5 border-t border-emerald-500/30">
									<div className="flex items-start gap-2">
										<svg
											className="w-5 h-5 flex-shrink-0 mt-0.5 text-amber-300"
											fill="none"
											viewBox="0 0 24 24"
											stroke="currentColor"
											strokeWidth={2}
										...
										<p className="text-xs text-emerald-100 leading-relaxed">
											College placement cells can use InterviewLabs to conduct
											AI-powered mock interviews for students, helping them
											practice and prepare for real placements with instant AI
											feedback, scoring, and detailed performance reports.
										</p>
									</div>
								</div>
							</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
								{tiers.map((tier) => (
									...
									>
										...
										<div className="mb-6">
											<h3
												className={`text-xl font-bold ${tier.highlight ? "text-white" : "text-white"}`}
											>
												{tier.name}
											</h3>
											<p
												className={`mt-2 text-sm ${tier.highlight ? "text-primary-100" : "text-gray-400"}`}
											>
												{tier.description}
											</p>
										</div>
										...
										<div className="mb-6">
											<div className="flex items-baseline gap-1">
												<span className="text-4xl font-bold text-white">
													{formatPrice(
														Math.round(currentPrices[tier.key] * discount),
														currency,
													)}
												</span>
												<span
													className={`text-sm ${tier.highlight ? "text-primary-200" : "text-gray-500"}`}
												>
													/mo
												</span>
											</div>
											{annual && (
												<p
													className={`text-xs mt-1 ${tier.highlight ? "text-primary-200" : "text-gray-500"}`}
												>
													Billed annually (
													{formatPrice(
														Math.round(currentPrices[tier.key] * discount * 12),
														currency,
													)}
													/yr)
												</p>
										...
										<ul className="mt-8 space-y-3">
											{tier.features.map((feature) => (
												<li key={feature} className="flex items-start gap-3">
													...
													<span
														className={`text-sm ${tier.highlight ? "text-primary-50" : "text-gray-300"}`}
													>
														{feature}
													</span>
												</li>
							...
							<div className="max-w-3xl mx-auto mt-16">
								<div className="bg-gray-900/50 border border-gray-800/50 rounded-2xl p-8 text-center">
									...
									<p className="text-gray-400 mt-2 text-sm">
										Additional interviews beyond your plan limit are billed per
										interview.
									</p>
				...
				<div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
					<div className="flex items-center gap-2">
						<span className="text-sm font-bold text-gray-400">
							Hire<span className="text-gray-300">Glint</span>
